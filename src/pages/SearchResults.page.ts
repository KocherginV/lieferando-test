...
export class SearchResultsPage {
  ...
  constructor(page: Page) {
    ...
    this.countryItemCheckbox = countryName =>
    ...
    this.jobsInFilter = (filterSelector, filterName) =>
      page.locator(
        `//*[@id="${filterSelector}"]//li[@data-ph-at-id="facet-results-item"]//*[text()=\'${filterName}\']/parent::label`,
      );
  }
}
